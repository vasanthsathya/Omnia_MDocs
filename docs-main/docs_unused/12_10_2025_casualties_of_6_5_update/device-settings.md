...
![](media/c1f711647daf72a0bacb5169a644b68b.png)

## Edit Device Settings
1. Click the Templates icon (![](media/buttons/6.3/button_templates.png){:class="btn"}) and the Templates tab.
1. Navigate to the Provisioning tile.
1. Double-click the Device Settings tile.
1. The form fields that appear contains editable settings. 
...
![](media/cut_through_switching_diagram.png)
