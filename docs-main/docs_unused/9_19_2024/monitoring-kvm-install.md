...
The VM console appears. The Monitoring initialization may take several minutes. While waiting you can press **Enter** and wait for login prompt. ![](media/monitoring_login.png){: class="pop"}
